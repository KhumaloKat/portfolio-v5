    ...
    <div className="flex flex-col w-[416px] h-[699px] items-start gap-[35px]">
      <div className="relative w-full h-[432px] gap-[10px] items-start group">
        <Image
          ...
          priority={priority}
        />
        <div className="absolute top-[330px] left-[300px] w-[114px] h-[114px] rounded-full bg-[#1D2939] group-hover:bg-[#7b7d7a] flex items-center justify-center transition-all duration-300">
          <ArrowButton
      ...
      <div className="flex flex-col gap-[35px] items-start">
        ...
        <div className="flex items-start gap-[35px]">
          <div className="flex items-center gap-2.5">
            <span className="bg-[#7b7d7a] w-[9px] h-[9px] rounded-full"></span>
